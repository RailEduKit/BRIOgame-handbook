...
\newcommand{\PVDH}{Paula von der Heide}
\newcommand{\JL}{Jiaming Liu}
\begin{versionhistory}
  ...
  \vhEntry{1.0.2}{2025-03-18}{PVDH|JL}{
    \IfLanguage{ngerman}{Behebung kleinerer Fehler, Formulierungen}
    \IfLanguage{english}{Fixing minor errors, rephrase tasks}
  }
